...
async def create_app():
    ...
    rtmt.system_message = "You are a helpful assistant from LemonMint Soutions. Only answer questions based on information you searched in the documents, accessible with the 'search' tool. " + \
